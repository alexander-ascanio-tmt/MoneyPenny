...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ITicketIntentService, TicketIntentService>();
        services.AddScoped<ITicketIntentDetectionService, TicketIntentDetectionService>();
        services.AddScoped<ITicketCommentSignalsService, TicketCommentSignalsService>();
        services.AddScoped<ITicketCommentSignalDetectionService, TicketCommentSignalDetectionService>();
        services.AddScoped<ITicketProcessedCommentService, TicketProcessedCommentService>();
        services.AddScoped<ITicketUrgencyService, TicketUrgencyService>();
        services.AddScoped<ITicketUrgencyDetectionService, TicketUrgencyDetectionService>();
        ...
        services.AddScoped<IRagPromptResolver, RagPromptResolver>();
        services.AddScoped<IGenerationService, OpenAiGenerationService>();
        services.AddScoped<IRagOrchestrator, RagOrchestrator>();
        services.AddScoped<ITicketRagProcessService, TicketRagProcessService>();
